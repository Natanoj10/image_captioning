...
# PyTorch GPU NVIDIA (si hay CUDA disponible)
...
```bash
# 1 — Descargar MS-COCO 2014 (~19 GB)
./download_coco.sh

# 2 — Entrenar modelo LSTM con fine-tuning
python train.py
...
Genera `results/external_validation.png` con las 12 imágenes comparando
...
| Modelo | Decodificación | BLEU-1 | BLEU-4 |
|--------|---------------|--------|--------|
| LSTM base (frozen) | Greedy | 0.6760 | 0.2181 |
| LSTM base (frozen) | Beam k=3 | 0.6846 | 0.2433 |
| **LSTM fine-tuned** | Greedy | 0.7157 | 0.2624 |
| **LSTM fine-tuned** | **Beam k=3** | **0.7304** | **0.2933** |
| GRU base (frozen) | Beam k=3 | 0.6899 | 0.2395 |
| GRU fine-tuned | Beam k=3 | 0.7314 | 0.2876 |
